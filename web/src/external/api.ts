...
export const api = makeApi([
  ...
  // Segmented Programs endpoints
  {
    method: 'get',
    path: '/api/segmented-programs',
    alias: 'getSegmentedPrograms',
    response: z.array(SegmentedProgramResponseSchema),
  },
  {
    method: 'get',
    path: '/api/segmented-programs/:id',
    alias: 'getSegmentedProgram',
    parameters: parametersBuilder().addPath('id', z.string()).build(),
    response: SegmentedProgramResponseSchema,
  },
  {
    method: 'post',
    path: '/api/segmented-programs',
    alias: 'createSegmentedProgram',
  ...
  },
  {
    method: 'delete',
    path: '/api/segmented-programs/:id',
    alias: 'deleteSegmentedProgram',
    parameters: parametersBuilder().addPath('id', z.string()).build(),
    response: z.void(),
  },
  {
    method: 'post',
    path: '/api/segmented-programs/validate',
    alias: 'validateSegmentedProgram',
    body: CreateSegmentedProgramRequestSchema,
    response: SegmentedProgramValidationResponseSchema,
  },
  ...settingsEndpoints,
  ...jellyfinEndpoints,
  ...embyEndpoints,
